...
class TestKeyConfigParser:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('yank-selected --sel', 'yank --sel -- {selection}'),
            ('yank-selected -p', 'yank -s -- {selection}'),

            ('yank -t', 'yank -- {title}'),
            ('yank -ts', 'yank -s -- {title}'),
            ('yank -d', 'yank -- {domain}'),
            ('yank -ds', 'yank -s -- {domain}'),
            ('yank -p', 'yank -- {url:pretty}'),
            ('yank -ps', 'yank -s -- {url:pretty}'),

            ('yank title', 'yank -- {title}'),
            ('yank pretty-url', 'yank -- {url:pretty}'),
            ('yank -ks domain', 'yank -ks -- {domain}'),
            ('yank selection -k', 'yank -k -- {selection}'),
