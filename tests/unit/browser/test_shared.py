...
@pytest.mark.parametrize('dnt, accept_language, custom_headers, expected', [
    # DNT
    (True, None, {}, {b'DNT': b'1', b'Do-Not-Track': b'1'}),
    (False, None, {}, {b'DNT': b'0', b'Do-Not-Track': b'0'}),
    (None, None, {}, {}),
    # Accept-Language
    (False, 'de, en', {}, {b'DNT': b'0', b'Do-Not-Track': b'0',
                           b'Accept-Language': b'de, en'}),
    # Custom headers
    (False, None, {'X-Qute': 'yes'}, {b'DNT': b'0', b'Do-Not-Track': b'0',
                                      b'X-Qute': b'yes'}),
    # Mixed
