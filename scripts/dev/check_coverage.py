...
PERFECT_FILES = [
    ...
    (None,
     'qutebrowser/completion/util.py'),
    ('tests/unit/completion/test_models.py',
     'qutebrowser/completion/strategies/urlmodel.py'),
    ('tests/unit/completion/test_models.py',
     'qutebrowser/completion/strategies/configmodel.py'),
    ('tests/unit/completion/test_models.py',
     'qutebrowser/completion/categories/filepathcategory.py'),
    ('tests/unit/completion/test_histcategory.py',
     'qutebrowser/completion/categories/histcategory.py'),
    ('tests/unit/completion/test_listcategory.py',
     'qutebrowser/completion/categories/listcategory.py'),
