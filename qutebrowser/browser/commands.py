...
class CommandDispatcher:
    ...
    def view_source(self, edit=False, pygments=False):
        ...
        Args:
            ...
            pygments: Use pygments to generate the view. This is always the
            case for webkit. For webengine it may display slightly different
            source (some javascript processing applied).
        """
        tab = self._current_widget()
        try:
