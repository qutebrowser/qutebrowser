...
displaying it to the user.
    - If you want to display the URL to the user, use `urlutils.safe_display_string()`
      so password information is removed and the Punycode URL is shown for IDN pages
      in addition to decoded one.
