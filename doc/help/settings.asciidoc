...
|==============
|Setting|Description
|<<storage-download-directory,download-directory>>|The directory to save downloads to. An empty value selects a sensible os-specific default. A value of % will do the same, also remembers the last used directory. Environment variables are expanded.
...
=== download-directory
The directory to save downloads to. An empty value selects a sensible os-specific default. A value of % will do the same, also remembers the last used directory. Environment variables are expanded.
